...
hat = TH1F("Trig_fired", "trig_fired all triggers", 100, 0, 18000000) # event firing any trigger. 
#hat.Sumw2()
...
hgmtpt = TH1F("reco_gm_pt", "reco_gm_pt & trigger", 100, 0, 500) # event firing the trigger AND at least 1 gm. 
hgmtpt.Sumw2()

hgmpt = TH1F("reco_gm_pt", "reco_gm_pt", 100, 0, 500) # event with at least 1 gm
hgmpt.Sumw2()

hgmeta = TH1F("reco_gm_eta", "reco_gm_eta", 100, -4, 4)
hgmeta.Sumw2()

hgmteta = TH1F("reco_gm_trig_eta", "reco_gm_trig_eta", 100, -4, 4)
hgmteta.Sumw2()
...
hgmdxy = TH1F("reco_gm_dxy", "reco_gm_dxy", 100, -5, 5)
hgmdxy.Sumw2()

hgmtdxy = TH1F("reco_gm_trig_dxy", "reco_gm_trig_dxy", 100, -5, 5)
hgmtdxy.Sumw2()
...
for event in mytree:
    ...
    #print(event.trig_fired)
    if ((event.trig_fired >> trig_bitpos) & 1) == 1:
        #print(bin(event.trig_fired))
